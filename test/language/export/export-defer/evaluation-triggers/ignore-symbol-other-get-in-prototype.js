...
// - src/export-defer/get-in-prototype.case
// - src/export-defer/trigger-on-exported/symbol-other.template
/*---
description: _ [[Get]] when namespace object is in the prototype chain (of an arbitrary symbol key, does not trigger evaluation)
...
info: |
    [[Get]] ( _P_, _Receiver_ ) — proposal-deferred-reexports amendment
      ...
      The key is a Symbol, so [[Get]] short-circuits at step 1 and
      delegates to OrdinaryGet before reaching the evaluation trigger.
...
assert.compareArray(globalThis.evaluations, ["barrel"],
  "operation with symbol key does not trigger deferred-source evaluation");
