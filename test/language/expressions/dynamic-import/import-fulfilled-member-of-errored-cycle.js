...
info: |
  ...
  [[TopLevelCapability]]. Evaluate() is well-defined on such a module: a fresh
  capability is created and installed as B's [[TopLevelCapability]],
  InnerModuleEvaluation returns the recorded [[EvaluationError]], and the
  capability is rejected with it. The import of C must therefore reject with
